...
# !/usr/bin/env python
"""
"Heidolph_MR_Hei_Connect" -- API for Heidolph MR Hei Connect remote controllable hotplate stirrer
=================================================================================================

.. module:: Heidolph_MR_Hei_Connect
   :platform: Windows
   :synopsis: Heidolph MR Hei Connect hotplate stirrer.
   :license: BSD 3-clause
.. moduleauthor:: Cronin Group 2018

(c) 2018 The Cronin Group, University of Glasgow

This provides a Python class for the Heidolph MR Hei Connect Hotplates. The command implementation is based on the
German manual version 1.3. Serial settings listed in the english version are wrong!
