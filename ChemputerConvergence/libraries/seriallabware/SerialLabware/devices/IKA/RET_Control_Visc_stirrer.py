...
# !/usr/bin/env python
"""
"IKA_RET_Control_Visc" -- API for IKA RET Control Visc remote controllable hotplate stirrer
===========================================================================================
...
The command implementation is based on the english manual: English manual version: 20000004159, RET control-visc_112015
Pages 31 - 34, the german version, same file pages 15 - 18 appears to contain more and better information.
...
if __name__ == '__main__':
    print ('start')
    hp = IKARETControlVisc(port="COM8", connect_on_instantiation=True)
