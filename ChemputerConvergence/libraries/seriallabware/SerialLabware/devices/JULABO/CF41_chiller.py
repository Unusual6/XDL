...
# !/usr/bin/env python
"""
"JULABO_CF41" -- API for Julabo CF41 remote controllable recirculation chiller
===================================
...
class JULABOCF41(SerialDevice):
    ...
    def get_temperature(self):
        ...
        Attempts to read the external probe first and falls back
        to internal if external probe not connected or reading is
        invalid."""
        try:
            return float(self.send_message(self.IN_PV_02, True))
        except ValueError:
