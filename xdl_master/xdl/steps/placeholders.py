...
from xdl_master.xdl.errors import XDLUnimplementedStepError
from xdl_master.xdl.steps.base_steps import Step
from xdl_master.xdl.steps.templates import (
...
def get_init_method(template_cls: type) -> str:
    ...
    non_defaults = [
        prop
        for prop in template_cls.MANDATORY_PROP_TYPES
...
def placeholder_step(template_cls: type) -> Callable:
    ...
    def inner_decorator(cls: type) -> type:
        ...
        class PlaceholderCls(template_cls):
            ...
            exec(get_init_method(template_cls))  # noqa: DUO105 # nosec B102
...
@placeholder_step(AbstractResetHandlingStep)
class ResetHandling:
