...
from xdl_master.xdl.steps.core.abstract_step import AbstractStep
from xdl_master.xdl.steps.templates.abstract_template import AbstractXDLElementTemplate
from xdl_master.xdl.utils.prop_limits import TEMP_PROP_LIMIT, TIME_PROP_LIMIT
from xdl_master.xdl.utils.vessels import VesselSpec


class AbstractCrystallizeStep(AbstractXDLElementTemplate, AbstractStep):
    ...
    def vessel_specs(self) -> Dict[str, VesselSpec]:
        return {"vessel": VesselSpec(min_temp=self.ramp_temp, max_temp=self.ramp_temp)}
