...
import xdl_master.xdl.variables as variables
...
from xdl_master.xdl.utils.schema import generate_schema
...
class AbstractPlatform:
    ...
    @property
    def variable_library(self) -> Dict[str, Type[variables.Variable]]:
        def is_variable(cls):
            return inspect.isclass(cls) and issubclass(cls, variables.Variable)

        return {m[0]: m[1] for m in inspect.getmembers(variables, is_variable)}
    ...
    def get_graph(self, graph_file: Union[str, Dict], **kwargs):
        """TODO: Add docstring"""
        pass
    ...
    def declaration(self) -> Dict[str, Any]:
        ...
        return {
            "steps": [
                {
                    ...
                    "DEFAULT_PROPS": dict(step.DEFAULT_PROPS, **{"comment": ""}),
            ...
            "Reagent": {
                ...
                "DEFAULT_PROPS": dict(Reagent.DEFAULT_PROPS, **{"comment": ""}),
            ...
            "Component": {
                ...
                "DEFAULT_PROPS": dict(Component.DEFAULT_PROPS, **{"comment": ""}),
            ...
            "Metadata": {
                "name": "Metadata",
                "PROP_TYPES": dict(
                    {k: type_str_dict[v] for k, v in Metadata.PROP_TYPES.items()},
                    **{"comment": "str"},
                ),
                "DEFAULT_PROPS": dict(Metadata.DEFAULT_PROPS, **{"comment": ""}),
