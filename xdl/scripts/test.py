...
# python -m xdl.scripts.test --step compile


# def main():
#     parser = argparse.ArgumentParser()
#     parser.add_argument('--xdl_file', default='chem_yan.xdl',type=str)
...
def main():
    ...
    # 1. 公共参数（所有步骤都可能用到）
    parser.add_argument(
        "--xdl_file", default="files/chem_yan1.xdl", type=str, help="输入xdl"
    )
    parser.add_argument(
        "--graph_file",
        default=None,
